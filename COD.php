...
<h3 class="text-center"> <strong>Your Order Number:</strong> <span style="color: blue;"><?php echo "$number"; ?></span> </h3>
    ...
    <?php
require_once('barcode.php'); // Include the barcode library

$barcodeText = "123456789"; // Data to encode into the barcode
$barcode = new BarcodeGenerator();
$barcode->output_image($barcodeText, 'png'); // Generate and output the barcode image
?>
